...
(function () {
  ...
  if (form) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      // Enviar para a nossa Cloudflare Pages Function local (que faz o proxy em formato JSON contornando CORS)
      fetch('/api/leads', {
        method: 'POST',
        headers: {
      ...
      .catch(function (err) {
        console.error('Erro ao enviar lead para o proxy:', err);
      });
